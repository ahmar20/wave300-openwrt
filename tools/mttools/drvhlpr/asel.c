...
rf_mgmt_start (void)
{
  ...
  case MTLK_RF_MGMT_TYPE_LBF:
    mode = RF_MGMT_MODE_SWITCH;
    break;
  case MTLK_RF_MGMT_TYPE_QBF_LBF:
    mode = RF_MGMT_MODE_SWITCH;
    break;
  case MTLK_RF_MGMT_TYPE_ONLY_QBF:
    mode = RF_MGMT_MODE_SWITCH;
    break;
  ...
  case RF_MGMT_MODE_DEBUG:
    if (_rf_mgmt_set_type(MTLK_RF_MGMT_TYPE_OFF) != MTLK_ERR_OK) {
      WLOG_V("Failed set to off RF Management type");
    }
