...
copy wavelog.dll %APPDATA%\Wireshark\plugins\*
...
:: Run the command
if /I "%3" == "/t" (
    wavelog_cat.exe %IP_ADDRESS% 2008 | %WIRESHARK_DIR%\Wireshark.exe -k -i - -w %FILENAME% -b filesize:%FILESIZE%
) else (
    wavelog_cat.exe %IP_ADDRESS% 2008 | %WIRESHARK_DIR%\Wireshark.exe -k -i -
)
