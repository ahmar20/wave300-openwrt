...
{
    uint8   u8IsRsnEnabled; //dot11RSNAActivated
...
typedef struct _PRE_ACTIVATE_MIB_TYPE
{
    ...
    uint32 u32BSSOperationalRateSet           ; // MIB_OPERATIONAL_RATE_SET
    uint32 u32BSSbasicRateSet              ; // MIB_BSS_BASIC_RATE_SET
    uint32 u32BSSSupportedRateSet          ; // MIB_BSS_SUPPORTED_RATE_SET
    uint32 u32BSSExtendedRateSet           ; // MIB_BSS_EXTENDED_RATE_SET
...
#define		MIB_REG_DOMAIN_AU   (0x44)
#define		MIB_REG_DOMAIN_BR   (0x45)
#define		MIB_REG_DOMAIN_CN   (0x46)
...
#define MIB_TWO_ANTENNA_TRANSMISSION_ENABLE 0x0067
...
#define		MIB_REG_DOMAIN_IL	  0x41
#define		MIB_REG_DOMAIN_SG	  0x42
...
#define MIB_SAQUERY_RETRY_TIMEOUT				0x0264
#define MIB_SAQUERY_MAX_TIMEOUT					0x0265

#define MIB_MAX_SIZE_COUNTRY_ELEMENT_SUBBAND_TRIPLETS		(32)

typedef struct _MIB_COUNTRY_ELEMENT_TRIPLET
{
    uint8  u8FirstChannelNumber;
    uint8  u8NumberOfChannels;
    uint8  u8MaximumTransmitPowerLevel;
    uint8  u8Reserved;
} __MTLK_PACKED MIB_COUNTRY_ELEMENT_TRIPLET;
...
#define MIB_COUNTRY_STRING_LENGTH (3)

typedef struct _MIB_COUNTRY_ELEMENT_INFO
{
    uint8 countryString[MTLK_PAD4(MIB_COUNTRY_STRING_LENGTH)];
	uint32 numOfSubBandTriplets;
    MIB_COUNTRY_ELEMENT_TRIPLET Table[MIB_MAX_SIZE_COUNTRY_ELEMENT_SUBBAND_TRIPLETS];
} __MTLK_PACKED MIB_COUNTRY_ELEMENT_INFO;
 ...
 * Access:          r
 *--------------------------------------------------------------------------*/
#define     MIB_CALIBRATION_ALGO_MASK           (MIB_MT_PHY_CFG + 0x0B) // Offline calibrations bit mask
#define     MIB_ONLINE_CALIBRATION_ALGO_MASK    (MIB_MT_PHY_CFG + 0x20) // Online calibrations bit mask
#define		TPC_BIT_VAL							MTLK_BFIELD_INFO(8, 1)  // The bit representing the TPC
#define		DEFAULT_WAVE300_OFFLINE_CALIB_ALGO_MASK   (0x01F9)
#define		DEFAULT_WAVE300_ONLINE_CALIB_ALGO_MASK    (0x00B1)

#define		DEFAULT_AR10_OFFLINE_CALIB_ALGO_MASK      (0x3FAE)	/*  changed according to calibration proc-bit enum for AR10/W400.  */
#define		DEFAULT_AR10_ONLINE_CALIB_ALGO_MASK       (0x2708)
...
#define     MIB_USE_RX_SHORT_CYCLIC_PREFIX      (MIB_MT_PHY_CFG + 0x06)
...
#define     MIB_USE_TX_SHORT_CYCLIC_PREFIX      (MIB_MT_PHY_CFG + 0x20)
#define     MIB_USE_SHORT_CYCLIC_PREFIX_RATE_31 (MIB_MT_PHY_CFG + 0x21)
...
typedef union _MIB_VALUE
{
    ...
    MIB_COUNTRY_ELEMENT_INFO    sCountry;
