...
#define UM_MAN_HW_DEPENDENT_CONFIG_REQ	(K_MSG_TYPE)0x0443 /*(MSG_REQ + MSG_UMI_COMP + UMI_MAN_MSG + 61)*/
#define MC_MAN_HW_DEPENDENT_CONFIG_CFM	(K_MSG_TYPE)0x1443 /*(MSG_CFM + MSG_UMI_COMP + UMI_MAN_MSG + 61)*/

#define UM_MAN_CHANGE_TX_POWER_LIMIT_REQ (K_MSG_TYPE)0x0444 /*(MSG_REQ + MSG_UMI_COMP + UMI_MAN_MSG + 62)*/
#define MC_MAN_CHANGE_TX_POWER_LIMIT_CFM (K_MSG_TYPE)0x1444 /*(MSG_CFM + MSG_UMI_COMP + UMI_MAN_MSG + 62)*/

#define UM_MAN_ADD_PEERAP_REQ          (K_MSG_TYPE)0x0445 /*(MSG_REQ + MSG_UMI_COMP + UMI_MAN_MSG + 63)*/
#define MC_MAN_ADD_PEERAP_CFM          (K_MSG_TYPE)0x1445 /*(MSG_CFM + MSG_UMI_COMP + UMI_MAN_MSG + 63)*/

#define UM_MAN_DELETE_PEERAP_REQ          (K_MSG_TYPE)0x0446 /*(MSG_REQ + MSG_UMI_COMP + UMI_MAN_MSG + 64)*/
#define MC_MAN_DELETE_PEERAP_CFM          (K_MSG_TYPE)0x1446 /*(MSG_CFM + MSG_UMI_COMP + UMI_MAN_MSG + 64)*/

#define UM_MAN_SET_RX_TH_REQ			 (K_MSG_TYPE)0x0447 /*(MSG_REQ + MSG_UMI_COMP + UMI_MAN_MSG + 73)*/
#define MC_MAN_SET_RX_TH_CFM			 (K_MSG_TYPE)0x1447 /*(MSG_CFM + MSG_UMI_COMP + UMI_MAN_MSG + 73)*/

#define UM_MAN_SET_RX_DUTY_CYCLE_REQ	 (K_MSG_TYPE)0x0448 /*(MSG_REQ + MSG_UMI_COMP + UMI_MAN_MSG + 74)*/
#define MC_MAN_SET_RX_DUTY_CYCLE_CFM	 (K_MSG_TYPE)0x1448 /*(MSG_CFM + MSG_UMI_COMP + UMI_MAN_MSG + 74)*/

#define UM_MAN_SET_CCA_TH_REQ			(K_MSG_TYPE)0x0449 /*(MSG_REQ + MSG_UMI_COMP + UMI_MAN_MSG + 75)*/
#define MC_MAN_SET_CCA_TH_CFM			(K_MSG_TYPE)0x1449 /*(MSG_CFM + MSG_UMI_COMP + UMI_MAN_MSG + 75)*/

#define UM_MAN_MBSS_PRE_ACTIVATE_REQ     (K_MSG_TYPE)0x0451 /*(MSG_REQ + MSG_UMI_COMP + UMI_MAN_MSG + 81)*/
#define MC_MAN_MBSS_PRE_ACTIVATE_CFM     (K_MSG_TYPE)0x1451 /*(MSG_CFM + MSG_UMI_COMP + UMI_MAN_MSG + 81)*/

#define UM_MAN_VAP_DB_REQ               (K_MSG_TYPE)0x0452  /*(MSG_REQ + MSG_UMI_COMP + UMI_MAN_MSG + 82)*/
#define MC_MAN_VAP_DB_CFM               (K_MSG_TYPE)0x1452 /*(MSG_CFM + MSG_UMI_COMP + UMI_MAN_MSG + 82)*/

#define UM_MAN_ACTIVATE_VAP_REQ     (K_MSG_TYPE)0x0453 /*(MSG_REQ + MSG_UMI_COMP + UMI_MAN_MSG + 83)*/
#define MC_MAN_ACTIVATE_VAP_CFM     (K_MSG_TYPE)0x1453 /*(MSG_CFM + MSG_UMI_COMP + UMI_MAN_MSG + 83)*/

#define UM_MAN_DEACTIVATE_VAP_REQ   (K_MSG_TYPE)0x0454 /*(MSG_REQ + MSG_UMI_COMP + UMI_MAN_MSG + 84)*/
#define MC_MAN_DEACTIVATE_VAP_CFM   (K_MSG_TYPE)0x1454 /*(MSG_CFM + MSG_UMI_COMP + UMI_MAN_MSG + 84)*/

#define UM_MAN_VAP_LIMITS_REQ		(K_MSG_TYPE)0x0455 /*(MSG_REQ + MSG_UMI_COMP + UMI_MAN_MSG + 85)*/
#define MC_MAN_VAP_LIMITS_CFM		(K_MSG_TYPE)0x1455 /*(MSG_CFM + MSG_UMI_COMP + UMI_MAN_MSG + 85)*/

#define UM_MAN_ENABLE_DETECTION_REQ		(K_MSG_TYPE)0x0456 /*(MSG_REQ + MSG_UMI_COMP + UMI_MAN_MSG + 86)*/
#define MC_MAN_ENABLE_DETECTION_CFM		(K_MSG_TYPE)0x1456 /*(MSG_CFM + MSG_UMI_COMP + UMI_MAN_MSG + 86)*/

#define UM_MAN_CHANGE_11B_THRESHOLD_REQ	(K_MSG_TYPE)0x0457 /*(MSG_REQ + MSG_UMI_COMP + UMI_MAN_MSG + 87)*/
#define MC_MAN_CHANGE_11B_THRESHOLD_CFM	(K_MSG_TYPE)0x1457 /*(MSG_CFM + MSG_UMI_COMP + UMI_MAN_MSG + 87)*/

#define UM_MAN_GET_11B_THRESHOLD_REQ	(K_MSG_TYPE)0x0458 /*(MSG_REQ + MSG_UMI_COMP + UMI_MAN_MSG + 87)*/
#define MC_MAN_GET_11B_THRESHOLD_CFM	(K_MSG_TYPE)0x1458 /*(MSG_CFM + MSG_UMI_COMP + UMI_MAN_MSG + 87)*/

#define UM_MAN_SEND_11B_SET_ANT_REQ	    (K_MSG_TYPE)0x0459 /*(MSG_REQ + MSG_UMI_COMP + UMI_DBG_MSG + 89)*/
#define UM_MAN_SEND_11B_SET_ANT_CFM		(K_MSG_TYPE)0x1459 /*(MSG_CFM + MSG_UMI_COMP + UMI_DBG_MSG + 89)*/

#define UM_MAN_SET_DEBUG_TPC_REQ		(K_MSG_TYPE)0x045A /*(MSG_REQ + MSG_UMI_COMP + UMI_DBG_MSG + 90)*/
#define MC_MAN_SET_DEBUG_TPC_CFM		(K_MSG_TYPE)0x145A /*(MSG_CFM + MSG_UMI_COMP + UMI_DBG_MSG + 90)*/

#define UM_MAN_SET_AGG_RATE_LIMIT_REQ	(K_MSG_TYPE)0x045B /*(MSG_REQ + MSG_UMI_COMP + UMI_DBG_MSG + 91)*/
#define MC_MAN_SET_AGG_RATE_LIMIT_CFM	(K_MSG_TYPE)0x145B /*(MSG_CFM + MSG_UMI_COMP + UMI_DBG_MSG + 91)*/

#define UM_MAN_SET_EXT_LNA_PARAMS_REQ	(K_MSG_TYPE)0x045C /*(MSG_REQ + MSG_UMI_COMP + UMI_DBG_MSG + 92)*/
#define MC_MAN_SET_EXT_LNA_PARAMS_CFM	(K_MSG_TYPE)0x145C /*(MSG_CFM + MSG_UMI_COMP + UMI_DBG_MSG + 92)*/

#define UM_MAN_FORCE_NCB_REQ			(K_MSG_TYPE)0x045D /*(MSG_REQ + MSG_UMI_COMP + UMI_DBG_MSG + 93)*/
#define MC_MAN_FORCE_NCB_CFM			(K_MSG_TYPE)0x145D /*(MSG_CFM + MSG_UMI_COMP + UMI_DBG_MSG + 93)*/

#define UM_MAN_SET_N_RATES_POWER_BO_REQ	(K_MSG_TYPE)0x045E /*(MSG_REQ + MSG_UMI_COMP + UMI_DBG_MSG + 94)*/
#define MC_MAN_SET_N_RATES_POWER_BO_CFM	(K_MSG_TYPE)0x145E /*(MSG_CFM + MSG_UMI_COMP + UMI_DBG_MSG + 94)*/

#define UM_MAN_RA_PROTECTION_REQ		(K_MSG_TYPE)0x045F /*(MSG_REQ + MSG_UMI_COMP + UMI_DBG_MSG + 95)*/
#define MC_MAN_RA_PROTECTION_CFM		(K_MSG_TYPE)0x145F /*(MSG_CFM + MSG_UMI_COMP + UMI_DBG_MSG + 95)*/ 

#define UM_MAN_SEND_11B_GET_ANT_REQ		(K_MSG_TYPE)0x0460 /*(MSG_REQ + MSG_UMI_COMP + UMI_DBG_MSG + 90)*/
#define UM_MAN_SEND_11B_GET_ANT_CFM		(K_MSG_TYPE)0x1460 /*(MSG_CFM + MSG_UMI_COMP + UMI_DBG_MSG + 90)*/

/* MulticastPs queue size */
#define	UM_MAN_MULTICAST_PS_SIZE_REQ	(K_MSG_TYPE)0x0461 /*(MSG_REQ + MSG_UMI_COMP + UMI_DBG_MSG + 97)*/
#define MC_MAN_MULTICAST_PS_SIZE_CFM	(K_MSG_TYPE)0x1461 /*(MSG_CFM + MSG_UMI_COMP + UMI_DBG_MSG + 97)*/

#define UM_MAN_SET_COEX_EL_TEMPLATE_REQ			(K_MSG_TYPE)0x04C8 /*(MSG_REQ + MSG_UMI_COMP + UMI_DBG_MSG + 8)*/
#define MC_MAN_SET_COEX_EL_TEMPLATE_CFM			(K_MSG_TYPE)0x14C8 /*(MSG_CFM + MSG_UMI_COMP + UMI_DBG_MSG + 8)*/

#define UM_MAN_SET_SCAN_EXEMPTION_POLICY_REQ	(K_MSG_TYPE)0x04CD /*(MSG_REQ + MSG_UMI_COMP + UMI_DBG_MSG + D)*/
#define MC_MAN_SET_SCAN_EXEMPTION_POLICY_CFM	(K_MSG_TYPE)0x14CD /*(MSG_REQ + MSG_UMI_COMP + UMI_DBG_MSG + D)*/

#define UM_MAN_SET_OBSS_SCAN_PARAMS_REQ			(K_MSG_TYPE)0x04CE /*(MSG_REQ + MSG_UMI_COMP + UMI_DBG_MSG + E)*/
#define MC_MAN_SET_OBSS_SCAN_PARAMS_CFM			(K_MSG_TYPE)0x14CE /*(MSG_CFM + MSG_UMI_COMP + UMI_DBG_MSG + E)*/

#define UM_MAN_SEND_COEX_FRAME_REQ		(K_MSG_TYPE)0x04CC /*(MSG_REQ + MSG_UMI_COMP + UMI_DBG_MSG + C)*/
#define MC_MAN_SEND_COEX_FRAME_CFM		(K_MSG_TYPE)0x14CC /*(MSG_CFM + MSG_UMI_COMP + UMI_DBG_MSG + C)*/


/* Management Indications */
//do not remove these 2 lines
//#define MC_MAN_MAC_EVENT_IND    (K_MSG_TYPE)0x3300  /*(MSG_IND + MSG_MAC_EVENT_COMP + UMI_MAN_MSG + 0)*/
//#define UM_MAN_MAC_EVENT_RES    (K_MSG_TYPE)0x2300  /*(MSG_RES + MSG_MAC_EVENT_COMP + UMI_MAN_MSG + 0)*/
...
#define MC_MAN_BA_TX_STATUS_IND		   (K_MSG_TYPE)0x3343 /*(MSG_IND + MSG_UMI_COMP + UMI_MAN_MSG + 84)*/
#define UM_MAN_BA_TX_STATUS_RES		   (K_MSG_TYPE)0x2343 /*(MSG_RES + MSG_UMI_COMP + UMI_MAN_MSG + 84)*/
...
#define MC_MAN_TRACE_IND			   (K_MSG_TYPE)0x3353 /*(MSG_IND + MSG_UMI_COMP + UMI_DBG_MSG + 83)*/
#define UM_MAN_TRACE_RES			   (K_MSG_TYPE)0x2353 /*(MSG_RES + MSG_UMI_COMP + UMI_DBG_MSG + 83)*/

#define MC_MAN_INTERFERER_IND		   (K_MSG_TYPE)0x3354 /*(MSG_IND + MSG_UMI_COMP + UMI_MAN_MSG + 84)*/	
#define UM_MAN_INTERFERER_RES		   (K_MSG_TYPE)0x2354 /*(MSG_RES + MSG_UMI_COMP + UMI_MAN_MSG + 84)*/	

#define MC_MAN_ACK_ON_BAR_IND		   (K_MSG_TYPE)0x3360 /*(MSG_RES + MSG_UMI_COMP + UMI_MAN_MSG + 84)*/
#define MC_MAN_ACK_ON_BAR_RES		   (K_MSG_TYPE)0x2360 /*(MSG_RES + MSG_UMI_COMP + UMI_MAN_MSG + 84)*/

#define MC_MAN_DFS_END_IND       		(K_MSG_TYPE)0x3361 /*(MSG_IND + MSG_UMI_COMP + UMI_MAN_MSG + 7)*/
#define UM_MAN_DFS_END_RES       		(K_MSG_TYPE)0x2361 /*(MSG_RES + MSG_UMI_COMP + UMI_MAN_MSG + 7)*/
...
#define UM_DBG_DUT_MSG_REQ				UM_DBG_C100_IN_REQ
#define MC_DBG_DUT_MSG_CFM				MC_DBG_C100_IN_CFM
...
#define UM_DBG_CLI_REQ     (K_MSG_TYPE)0x06CE /*(MSG_REQ + MSG_UMI_COMP + UMI_DBG_MSG + E)*/
#define MC_DBG_CLI_CFM     (K_MSG_TYPE)0x16CE /*(MSG_CFM + MSG_UMI_COMP + UMI_DBG_MSG + E)*/

#define UM_DBG_FW_DBG_REQ			   (K_MSG_TYPE)0x06CC
#define UM_DBG_FW_DBG_CFM			   (K_MSG_TYPE)0x16CC
...
#define LM_PHY_11N_NO_130_SCP_RATE_MSK  (LM_PHY_11N_NO_MIMO_RATE_MSK|LM_PHY_11N_MIMO_RATE_MSK)
...
#ifdef DISABLE_1M_RATE
/* Workaround for Prodea: disabling 1M rate in B, G and B/G */
#define LM_PHY_11B_LONG_RA_RATE_MSK		(LM_PHY_11B_LONG_RATE_MSK & ( ~LM_PHY_11B_RATE_1_MSK ))
#define LM_PHY_11B_SHORT_RA_RATE_MSK	(LM_PHY_11B_SHORT_RATE_MSK & ( ~LM_PHY_11B_RATE_1_MSK ))
#define LM_PHY_11G_LONG_RA_RATE_MSK		(( LM_PHY_11A_RATE_MSK | LM_PHY_11B_LONG_RA_RATE_MSK  & ~( LM_PHY_11B_RATE_5_MSK | LM_PHY_11B_RATE_11_MSK ) ) & ( ~LM_PHY_11B_RATE_1_MSK )) /* mask for 11G RA (with 11B long preamble supported only) */
#define LM_PHY_11G_SHORT_RA_RATE_MSK	(( LM_PHY_11A_RATE_MSK | LM_PHY_11B_SHORT_RA_RATE_MSK & ~( LM_PHY_11B_RATE_5_SHORT_MSK | LM_PHY_11B_RATE_11_SHORT_MSK ) ) & ( ~LM_PHY_11B_RATE_1_MSK )) /* mask for 11G RA (with 11B short preamble supported) */
#else
...
/***************************************************************************
**
** NAME         UMI_BA_TX_STATUS
**
** PARAMETERS   sDA   - IEEE address
**				u16MessageId - DelBA/AddBAres -  Origin Request Id (UM_MAN_DELBA_REQ/UM_MAN_ADDBA_RES_TX_REQ) 
**				u16AccessProtocol				- uint16
**				u8Initiator						- initiator of the DelBA
**				u16Status -						- uint16
**
** DESCRIPTION: This message should be sent in order to inform Driver about 
**				the transmission status of DelBA/AddBAres frames.  
**              
**
****************************************************************************/
typedef struct UMI_BA_TX_STATUS
{
	IEEE_ADDR sDA;
	uint16 u16MessageId;
	...
	uint8 u8Initiator; 		
	uint8 u8Status; 
} __MTLK_PACKED UMI_BA_TX_STATUS;


/***************************************************************************
**
** NAME         UMI_ACK_ON_BAR_EVENT
**
** PARAMETERS   sDA   - IEEE address
**				u8Priority - priority of the TID related to the BAR
**
** DESCRIPTION: This message should sent whenever there is an event of getting an 
				acknowledgment in response of BAR transmission
**
****************************************************************************/
typedef struct UMI_ACK_ON_BAR_EVENT
{
	IEEE_ADDR sDA;
	uint16 u16AccessProtocol; 	 
} __MTLK_PACKED UMI_ACK_ON_BAR_EVENT;
...
typedef struct
{
	...
	uint8 status;
	uint8 reserved;
	int16 i16CbTransmitPowerLimit;
	int16 i16nCbTransmitPowerLimit;
...
typedef struct  _UMI_OBSS_SCAN_PARAMS
{
	uint8		u8_MustInclude;
	uint8		u8_Reserved;
...
__MTLK_PACKED UMI_OBSS_SCAN_PARAMS;
...
typedef struct _UMI_ACTIVATE_VAP
{
  ...
  uint32	 	extendedRateSet;
  uint32	 	operationalRateSet;
  MIB_ESS_ID    sSSID;
  UMI_RSN_IE    sRSNie;
  uint8			u8UapsdInfo; /* new field for upasd */ 
  uint8			pmfActivated;
  uint8			pmfRequired;
  uint8			reserved; 
...
typedef struct _UMI_CONNECTION_EVENT
{
	...
	uint16		u16Sid; // sta id from FW perspective, is assigned to sStationID
	...
	uint8		fortyMHzMode; //fortyMHzMode will be set to 1 if the station has connected to the AP in 40 MHz mode and to 0 otherwise.
	uint8       u8PeerAP;
	uint8		uapsdParams; /* UAPSD info -  delivery enabled ACs bitmap (bots 0-3), MAX_SP_LENGTH (bits 4-7) */
	uint8		reserved[1]; 
...
**
****************************************************************************/
typedef struct _UMI_PEERAP_REQ
{
    uint16    u16Status;
    IEEE_ADDR sStationID;
} __MTLK_PACKED UMI_PEERAP_REQ;
...
typedef struct _UMI_OPEN_AGGR_REQ
{
	...
	uint8		windowSize;
	uint8		u8TsId; /* TS index allocated following the request */
	uint16		reserved; 
...
typedef struct _UMI_CLOSE_AGGR_REQ
{
    ...
    uint16      u16AccessProtocol;
	uint16      u16Status;
	uint8		u8TsId; /* TS index- reported on OPEN AGGR CFM */
	uint8      	reserved;
...
{
	int8 TxPower11bBoost;
	int8 TxPowerBpskBoost;
	int8 TxPowerAutoRspBoost;
    uint8 Status;
...
/***************************************************************************
**
** NAME         UMI_INTERFERER_DETECTION
**
** PARAMETERS   mode						- Enable(1) or Disable(0)
**				threshold					- detection threshold in dBm
**				status						- request status (UMI_OK or error)
**				ActivePollingTimeout		- polling timeout for active mode in milliseconds
**				ScanPollingTimeout			- polling timeout for scan mode in milliseconds
**				ActiveNotificationTimeout	- notification timeout for active mode in multiplies of ActivePollingTimeout
**				ScanNotificationTimeout		- notification timeout for scan mode in multiplies of ScanPollingTimeout
**
** DESCRIPTION  Return message buffer.
**
****************************************************************************/
#define DETECTION_DISABLED 0
...
typedef struct  
{
	...
	int8	threshold;
	uint16	status;
	uint32	ActivePollingTimeout;
	uint32	ScanPollingTimeout;
	uint32	ActiveNotificationTimeout;
	uint32	ScanNotificationTimeout;
} UMI_INTERFERER_DETECTION;
...
#define TX_EXTRA_ENCAP_TYPE				MTLK_BFIELD_INFO(0, 6)  /* 6 LS bits */
...
/* values for u16Sid */
#define UMI_SID_MULTICAST 			(0xFFFF)
#define UMI_SID_DIRECT_MULTICAST	(0xFFFE)
...
/***************************************************************************
**
** NAME         UMI_EXT_LNA_PARAMS
**
** PARAMETERS	extLnaGainBypass
**              		extLnaGainHigh
**
** DESCRIPTION: This purpose of this message is to set external LNA parameters
**
**
****************************************************************************/

typedef struct _UMI_EXT_GAIN_PARAMS
{
	int8  extLnaGainBypass;
	int8  extLnaGainHigh;
	uint8 status;
	uint8 reserved;
} UMI_EXT_LNA_PARAMS;
...
/***************************************************************************
**
** NAME         UM_MAN_CHANGE_11B_THRESHOLD_REQ
**
** PARAMETERS	Consecutive11bTH - Number of consecutive ACKs before trying to probe 11n rate
**              		Consecutive11nTH - Number of consecutive ACKs before switching 11b flag off
**
** DESCRIPTION: This purpose of this message is to set the thresholds of the Enhanced 11b feature.
**
**
****************************************************************************/
typedef struct _UMI_Enhanced11bTH_Req
{
    uint8	Consecutive11bTH;
    uint8	Consecutive11nTH;
} __MTLK_PACKED UMI_Enhanced11bTH_Req;
...
**              
*****************************************************************************/
#define MAX_MPS_FSDUS_PER_VAP 5
#define DEFAULT_MPS_TO_TRANSMITT_IN_DTIM MAX_MPS_FSDUS_PER_VAP

typedef struct _UMI_MULTICAST_PS_SIZE
{
	uint8 maxNumberOfFsdus;
	
} __MTLK_PACKED UMI_MULTICAST_PS_SIZE;
...
/***************************************************************************
**
** NAME         UMI_RA_PROTECTION
**
** PARAMETERS   
**
**			Mode  - enable\disable RA protection
**			Status - return status
**
** DESCRIPTION  
**              
...
typedef struct UMI_RA_PROTECTION
{
	uint8 Mode;	
	uint8 Status;
} __MTLK_PACKED UMI_RA_PROTECTION;
...
** PARAMETERS   
**
**			Mode  - enable\disable NCB forcing
**			Status - return status
**
** DESCRIPTION  
**              
...
typedef struct UMI_FORCE_NCB
{
	uint8 Mode;	
	uint8 Status;
} __MTLK_PACKED UMI_FORCE_NCB;
...
** PARAMETERS   
**
**	QAM16backoff	    - backoff value for QPSK & QAM16 rates. Given in 1/8 dBm resolution.
**	QAM64_2_3_backoff - boost value for QAM64 2/3 MCS. Given in 1/8 dBm resolution.
**	QAM64_3_4_backoff - boost value for QAM64 3/4 MCS. Given in 1/8 dBm resolution.
**	QAM64_5_6_backoff - boost value for QAM64 5/6 MCS. Given in 1/8 dBm resolution.
**
** DESCRIPTION  
**              
*****************************************************************************/

typedef struct UMI_N_RATES_BO
{
	int8 QAM16backoff;
	int8 QAM64_2_3_backoff;
	int8 QAM64_3_4_backoff;
	int8 QAM64_5_6_backoff;	
} __MTLK_PACKED UMI_N_RATES_BO;
