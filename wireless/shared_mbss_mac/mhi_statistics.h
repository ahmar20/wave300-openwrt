...
MTIDL_ENUM_START
  ...
  MTIDL_ENUM_ENTRY(UMI_BSS_UNSPECIFIED,          255,  "Unspecified")
...
MTIDL_ENUM_START
  ...
  MTIDL_ENUM_ENTRY(FM_STATUSCODE_MAC_ADDRESS_FILTER,                 112,  "STA's MAC address is not allowed in this BSS due to ACL Rule")
...
#define STAT_TX_PAUSE_FAIL					96
#define STAT_LM_STOP_FAIL					97
#define STAT_ACK_ON_BAR                     98

#define STAT_SWITCH_TO_11B					99	/* Number of times rates were switched from 11n to 11b */
#define STAT_SWITCH_TO_11N                  100 /* Number of times rates were switched from 11b to 11n */
#define STAT_AGGREGATION_TO_LEGACY			101 /* Number of packets with forced 11b rate which were part of disassembled aggregation */
#define STAT_FORCED_11B_TRANSMITTED			102 /* Number of packets with forced 11b rate which were transmitted */
#define STAT_PROCESS_FEEDBACK_11B			103 /* Number of packets with forced 11b rate which were processed after feedback */

#define STAT_AGGR_CANCELLED					104	/* Number of Cancelled AGGRs */
#define STAT_UAPSD_RX_TRIGGER_FRAMES        105  /* Number of Rx trigger frames */
#define	STAT_UAPSD_TX_FRAMES_IN_SP			106	 /* Number of Tx frames sent in a service period  */ 
#define	STAT_UAPSD_TX_QOS_NULL_DATA			107	 /* Number of Tx QOS NULL DATA frames transmitted in response to trigger frame  */ 

/* 802.11W start*/
#define STAT_RX_SAQUERY_REQ					108 /* Number of received SAQuery request */
#define STAT_RX_SAQUERY_RES					109 /* Number of received SAQuery response */
#define STAT_TX_SAQUERY_REQ					110 /* Number of transmitted SAQuery request */
#define STAT_TX_SAQUERY_RES					111 /* Number of transmitted SAQuery response */

#define STAT_RX_PROTECTED_UNICAST_ROBUST_MNGT_FR 		112 /* Number of received protected unicast robust management frames */
#define STAT_TX_PROTECTED_UNICAST_ROBUST_MNGT_FR 		113 /* Number of tramsmitted protected unicast robust management frames */

#define STAT_RX_IGNORED_REJECTED_PMF		114 /* Number of ignored or rejected protected management frames */
#define STAT_SAQUERY_SUCCESS				115 /* Number of SAQuery success procedure */
#define STAT_SAQUERY_FAIL					116 /* Number of SAQuery fail procedure */
/* 802.11W end */
#define STAT_ONLINE_CALIB_FRAG_FAIL         117	/* Number of online calibration failed frgments */

#define STAT_TOTAL_NUMBER                   118  /* Size of stats array  */
...
#define STAT_CLOSE_COND_MAX_BYTES_PER_RATE	22
#define STAT_AGGR_TOTAL_NUMBER              23  /* Size of stats array - this define is always last  */
...
/* Statistics structs using MTIDL*/		
	...
	MTIDL_ITEM_START(RxDiscardedFw, MTIDL_STATISTICS, MTIDL_PROVIDER_HW, MTIDL_SRC_FW, DBG_STATS_RX_DISCARD_REASONS, "Firmware RX packets discard statistics")
		...
		MTIDL_LONGVAL( MT_STAT_RX_PACKET_OVERSIZE, "Oversized Packets")
		MTIDL_LONGVAL( MT_STAT_RX_FRAG_OVERSIZE, "Oversized Fragment")
		MTIDL_LONGVAL( MT_STAT_RX_MAX_BUFFER_OUT, "No RX Buffer available - pending")
		MTIDL_LONGVAL( MT_STAT_MPDU_IGNORED_SWITCH, "Packets discarded due to Channel Switch")
	...
	MTIDL_ITEM_START(TxDiscardedFw, MTIDL_STATISTICS, MTIDL_PROVIDER_HW, MTIDL_SRC_FW, DBG_STATS_TX_DISCARD_REASONS, "Firmware TX packets discard statistics")
		...
		MTIDL_LONGVAL(MT_STAT_INACTIVE_TOUT, "Inactive Timeout")
		MTIDL_LONGVAL(MT_STAT_FSDU_TIME_OUT, "FSDU timeout")
		MTIDL_LONGVAL(MT_STAT_TS_PS_TIME_OUT, "TS Power Save timeout")
	...
	MTIDL_ITEM_START(HWEncrypterStats, MTIDL_STATISTICS, MTIDL_PROVIDER_HW, MTIDL_SRC_FW, DBG_STATS_SECURITY, "HW encrypter statistics")
		...
		MTIDL_LONGVAL(MT_STAT_SECURITY_TX_PENDING, "Number of packets which are on encryption pending queue")
		MTIDL_LONGVAL(MT_STAT_SECURITY_RX_PENDING, "Number of packets which are on decryption pending queue")
		...
		MTIDL_LONGVAL(MT_STAT_SECURITY_TX_FAIL_LEN_ZERO, "Number of encryption failures due to FSDU with payload len = 0")
		MTIDL_LONGVAL(MT_STAT_SECURITY_TX_FAIL_KEY_LEN_ZERO, "Number of encryption failures due to key with len = 0")
	...
	MTIDL_ITEM_START(AggregationsStats, MTIDL_STATISTICS, MTIDL_PROVIDER_HW, MTIDL_SRC_FW, DBG_STATS_AGGREGATIONS, "Aggregations statistics")
		...
		MTIDL_LONGVAL(MT_STAT_RECIEVED_BA, "Number of Received BA")
		...
		MTIDL_LONGVAL(MT_STAT_CLOSE_COND_MAX_BYTES_PER_RATE, "Aggregation closed due to max bytes per rate")
  ...
  MTIDL_ITEM_START(FWFlowStatus, MTIDL_STATISTICS, MTIDL_PROVIDER_HW, MTIDL_SRC_FW, DBG_STATS_FWSTATUS, "Firmware packets flow statistics")
		...
		MTIDL_LONGVAL(FW_STAT_OUT_OF_RX_MSDUS,               "Out of RX MSDUs")
		...
		MTIDL_LONGVAL(FW_STAT_TX_PAUSE_FAIL,				 "Number of failed pause TX requests")
		MTIDL_LONGVAL(FW_STAT_LM_STOP_FAIL,					 "Number of failed STOP LM requests")
		MTIDL_LONGVAL(FW_STAT_ACK_ON_BAR,                    "Number of ACK on BAR events")
		MTIDL_LONGVAL(FW_STAT_SWITCH_TO_11B,				 "Number of times rates were switched from 11n to 11b")
		MTIDL_LONGVAL(FW_STAT_SWITCH_TO_11N,				 "Number of times rates were switched from 11b to 11n")
		MTIDL_LONGVAL(FW_STAT_AGGREGATION_TO_LEGACY,		 "Number of packets with forced 11b rate which were part of disassembled aggregation")
		MTIDL_LONGVAL(FW_STAT_FORCED_11B_TRANSMITTED,		 "Number of packets with forced 11b rate which were transmitted")		
		MTIDL_LONGVAL(FW_STAT_PROCESS_FEEDBACK_11B,			 "Number of packets with forced 11b rate which were processed after feedback")
		MTIDL_LONGVAL(FW_STAT_AGGR_CANCELLED,				 "Number of Cancelled AGGRs")
		MTIDL_LONGVAL(FW_STAT_UAPSD_RX_TRIGGER_FRAMES,       "Number of Rx trigger frames")
		MTIDL_LONGVAL(FW_STAT_STAT_UAPSD_TX_FRAMES_IN_SP,    "Number of Tx frames sent in a service period")
		MTIDL_LONGVAL(FW_STAT_STAT_UAPSD_TX_QOS_NULL_DATA,   "Number of Tx QOS NULL DATA frames transmitted in response to trigger frame")
		MTIDL_LONGVAL(FW_STAT_RX_SAQUERY_REQ,	 "Number of received SAQuery request")
		MTIDL_LONGVAL(FW_STAT_RX_SAQUERY_RES,	 "Number of received SAQuery response")
		MTIDL_LONGVAL(FW_STAT_TX_SAQUERY_REQ,	 "Number of transmitted SAQuery request")
		MTIDL_LONGVAL(FW_STAT_TX_SAQUERY_RES,	 "Number of transmitted SAQuery response")
		MTIDL_LONGVAL(FW_STAT_RX_PROTECTED_UNICAST_ROBUST_MNGT_FR,	 "Number of received protected unicast robust management frames")
		MTIDL_LONGVAL(FW_STAT_TX_PROTECTED_UNICAST_ROBUST_MNGT_FR,	 "Number of tramsmitted protected unicast robust management frames")
		MTIDL_LONGVAL(FW_STAT_RX_IGNORED_REJECTED_PMF,	 "Number of ignored or rejected protected management frames")
		MTIDL_LONGVAL(FW_STAT_SAQUERY_SUCCESS,	 "Number of SAQuery success procedure")
		MTIDL_LONGVAL(FW_STAT_SAQUERY_FAIL,	 "Number of SAQuery fail procedure")
		MTIDL_LONGVAL(FW_STAT_ONLINE_CALIB_FRAG_FAIL, "Number of times online calibration fragment failed")
