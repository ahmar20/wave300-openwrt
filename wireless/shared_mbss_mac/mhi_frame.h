...
#define MTLK_RF_MGMT_TYPE_LBF           0x03   //Only LBF 
#define MTLK_RF_MGMT_TYPE_QBF_LBF       0x04   //LBF & QBF
#define MTLK_RF_MGMT_TYPE_ONLY_QBF      0x05   //Only QBF   
#define MTLK_RF_MGMT_TYPE_AIRGAIN_ASEL  0x06
