...
typedef union _UMI_MAN
{
	...
	UMI_INTERFERER_DETECTION		sUmiInterfererDetection;
	UMI_INTERFERER					sUmiInterferer;
	UMI_BA_TX_STATUS				sUmiBATxStatus;
	UMI_ACK_ON_BAR_EVENT			sUmiAckOnBarEvent;
	UMI_ANT_SELECTION_11B			sUmi11bAntSel;
	UMI_MULTICAST_PS_SIZE			sUmiMulticastPsSize;
	UMI_DEBUG_TPC					sDebugTpc;
	UMI_AGG_RATE_LIMIT				sAggRateLimit;
