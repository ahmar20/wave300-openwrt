...
/* VAP Manager API */
mtlk_vap_manager_t * __MTLK_IFUNC mtlk_vap_manager_create(mtlk_hw_api_t *hw_api, mtlk_work_mode_e work_mode);
...
int                  __MTLK_IFUNC mtlk_vap_manager_create_vap(mtlk_vap_manager_t *obj,
                                                              ...
                                                              uint8 vap_index);
void                 __MTLK_IFUNC mtlk_vap_manager_delete_master_vap(mtlk_vap_manager_t *obj);
...
int                  __MTLK_IFUNC mtlk_vap_manager_prepare_start(mtlk_vap_manager_t *obj,
                                                                 mtlk_handle_t      txmm_handle,
                                                                 mtlk_handle_t      txdm_handle);
void                 __MTLK_IFUNC mtlk_vap_manager_unprepare(mtlk_vap_manager_t *obj);
...
int                  __MTLK_IFUNC mtlk_vap_manager_get_vap_handle(mtlk_vap_manager_t *obj,
                                                                  uint8               vap_id,
                                                                  mtlk_vap_handle_t  *vap_handle);
mtlk_work_mode_e     __MTLK_IFUNC mtlk_vap_manager_get_mode(mtlk_vap_manager_t *obj);
void __MTLK_IFUNC
...
mtlk_vap_get_oid(mtlk_vap_handle_t vap_handle)
{
  ...
  return ( ((uint16)_info->hw_idx) << 8) | _info->id;
}
