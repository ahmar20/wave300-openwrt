...
static const mtlk_ability_id_t _core_general_abilities[] = {
  ...
  MTLK_CORE_REQ_GET_DOT11W_CFG,
  MTLK_CORE_REQ_SET_DOT11W_CFG
};
...
static const mtlk_ability_id_t _core_master_general_abilities[] = {
  ...
  MTLK_CORE_REQ_SET_ENHANCED11B_CFG,
  MTLK_CORE_REQ_GET_ENHANCED11B_CFG,
  MTLK_CORE_REQ_GET_COEX_20_40_RSSI_THR_CFG,
  MTLK_CORE_REQ_SET_COEX_20_40_RSSI_THR_CFG,
};
...
static const mtlk_ability_id_t _core_ap_general_abilities[] = {
  ...
  MTLK_CORE_REQ_SET_MC_PS_SIZE_CFG,
  MTLK_CORE_REQ_GET_MC_PS_SIZE_CFG
};
...
static const mtlk_ability_id_t _core_ps_abilities[] = {
  MTLK_CORE_REQ_SET_UAPSD_MODE,
  MTLK_CORE_REQ_GET_UAPSD_MODE,
  MTLK_CORE_REQ_SET_UAPSD_CFG,
  MTLK_CORE_REQ_GET_UAPSD_CFG,
  MTLK_CORE_REQ_GET_PS_STATUS
};

static const mtlk_ability_id_t _core_ps_restricted_abilities[] = {
  MTLK_CORE_REQ_SET_UAPSD_MODE,
};
...
static const mtlk_ab_tbl_item_t mtlk_core_abilities_master_ap_init_tbl[]= {
    ...
    { _core_ps_abilities,                 ARRAY_SIZE(_core_ps_abilities)},
...
void
mtlk_core_abilities_disable_ps_abilities (mtlk_vap_handle_t vap_handle)
{
  mtlk_abmgr_disable_ability_set(mtlk_vap_get_abmgr(vap_handle), _core_ps_restricted_abilities,
                                 ARRAY_SIZE(_core_ps_restricted_abilities));
}

void
mtlk_core_abilities_enable_ps_abilities (mtlk_vap_handle_t vap_handle)
{
  mtlk_abmgr_enable_ability_set(mtlk_vap_get_abmgr(vap_handle), _core_ps_restricted_abilities,
                                ARRAY_SIZE(_core_ps_restricted_abilities));
}
