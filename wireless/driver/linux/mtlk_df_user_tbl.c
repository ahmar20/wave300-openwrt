...
static const struct iw_priv_args mtlk_linux_privtab[] = {
  ...
  SET_INT     (MIB_TWO_ANTENNA_TRANSMISSION_ENABLE         , "sTwoAntennaTxEn" )
  GET_INT     (MIB_TWO_ANTENNA_TRANSMISSION_ENABLE         , "gTwoAntennaTxEn" )
  ...
  SET_INT     (PRM_USE_SHORT_CYCLIC_PREFIX_RX              , "sScpRx"          )
  GET_INT     (PRM_USE_SHORT_CYCLIC_PREFIX_RX              , "gScpRx"          )
  SET_INT     (PRM_USE_SHORT_CYCLIC_PREFIX_TX              , "sScpTx"          )
  GET_INT     (PRM_USE_SHORT_CYCLIC_PREFIX_TX              , "gScpTx"          )
  SET_INT     (PRM_USE_SHORT_CYCLIC_PREFIX_RATE31          , "sScpRate31"      )
  GET_INT     (PRM_USE_SHORT_CYCLIC_PREFIX_RATE31          , "gScpRate31"      )
  SET_INT     (PRM_ID_SHORT_PREAMBLE_OPTION_IMPLEMENTED    , "sShortPreamble"  )
  GET_INT     (PRM_ID_SHORT_PREAMBLE_OPTION_IMPLEMENTED    , "gShortPreamble"  )
  SET_INT     (PRM_ID_SHORT_SLOT_TIME_OPTION_ENABLED_11G   , "sShortSlotTime"  )
  GET_INT     (PRM_ID_SHORT_SLOT_TIME_OPTION_ENABLED_11G   , "gShortSlotTime"  )
  ...
  SET_INT     (PRM_ID_AOCS_RESTRICT_MODE                   , "sAocsRestrictMd"  )
  GET_INT     (PRM_ID_AOCS_RESTRICT_MODE                   , "gAocsRestrictMd"  )
  ...
  /* Non wifi noise */
  SET_INTVEC  (PRM_ID_AOCS_NON_WIFI_NOISE                  , "sNonWIFINoise"   )
  GET_INTVEC  (PRM_ID_AOCS_NON_WIFI_NOISE                  , "gNonWIFINoise"   )
  ...
  SET_TEXT    (PRM_ID_DELBA_REQ                            , "sDELBA"          )
  ...
  SET_INT     (PRM_ID_PEERAP_DBG                           , "sPeerAPDBG"      )
  ...
  SET_INT     (PRM_ID_DEBUG_TPC                            , "sDebugTPC"       )
  GET_INT     (PRM_ID_DEBUG_TPC                            , "gDebugTPC"       )
  ...
  SET_INT     (PRM_ID_BSS_BASIC_RATE_SET                   , "sBasicRates"     )
  GET_INT     (PRM_ID_BSS_BASIC_RATE_SET                   , "gBasicRates"     )
  SET_INT     (PRM_ID_BSS_SUPPORTED_RATE_SET               , "sSupportedRates" )
  GET_INT     (PRM_ID_BSS_SUPPORTED_RATE_SET               , "gSupportedRates" )
  SET_INT     (PRM_ID_BSS_EXTENDED_RATE_SET                , "sExtendedRates"  )
  GET_INT     (PRM_ID_BSS_EXTENDED_RATE_SET                , "gExtendedRates"  )
  ...
  SET_INT     (PRM_ID_RX_HIGH_THRESHOLD                    , "sSetRxTH"        )
  GET_INT     (PRM_ID_RX_HIGH_THRESHOLD                    , "gSetRxTH"        )
  SET_INT     (PRM_ID_CCA_THRESHOLD                        , "sCcaTH"          )
  GET_INT     (PRM_ID_CCA_THRESHOLD                        , "gCcaTH"          )
  ...
  SET_INTVEC  (PRM_ID_TX_POWER_LIMIT                       , "sTxPowerLimOpt"  )
  GET_INTVEC  (PRM_ID_TX_POWER_LIMIT                       , "gTxPowerLimOpt"  )

  SET_INTVEC  (PRM_ID_VAP_LNA_GAINS                        , "sExtLnaGains"    )
  GET_INTVEC  (PRM_ID_VAP_LNA_GAINS                        , "gExtLnaGains"    )

  /* 20/40 coexistence */
  SET_INT     (PRM_ID_COEX_MODE                            , "sCoexMode"       )
  GET_INT     (PRM_ID_COEX_MODE                            , "gCoexMode"       )

  SET_INT     (PRM_ID_COEX_THRESHOLD                       , "sCoexThreshold"  )
  GET_INT     (PRM_ID_COEX_THRESHOLD                       , "gCoexThreshold"  )

  SET_INT     (PRM_ID_INTOLERANCE_MODE                     , "sCoexIntolMode"  )
  GET_INT     (PRM_ID_INTOLERANCE_MODE                     , "gCoexIntolMode"  )

  SET_INT     (PRM_ID_SCAN_AP_FORCE_SCAN_PARAMS_ON_ASSOC_STA,"sCoexAPForcePms" )
  GET_INT     (PRM_ID_SCAN_AP_FORCE_SCAN_PARAMS_ON_ASSOC_STA,"gCoexAPForcePms" )

  SET_INT     (PRM_ID_SCAN_AP_WAIT_FOR_SCAN_RESULTS_INTERVAL,"sCoexScnResWait" )
  GET_INT     (PRM_ID_SCAN_AP_WAIT_FOR_SCAN_RESULTS_INTERVAL,"gCoexScnResWait" )

  SET_INT     (PRM_ID_EXEMPTION_REQ                        , "sCoexExemptReq"  )
  GET_INT     (PRM_ID_EXEMPTION_REQ                        , "gCoexExemptReq"  )

  SET_INT     (PRM_ID_MIN_NON_EXEMPTED_STA                 , "sCoexMinNoExmSta")
  GET_INT     (PRM_ID_MIN_NON_EXEMPTED_STA                 , "gCoexMinNoExmSta")

  SET_INT     (PRM_ID_DELAY_FACTOR                         , "sCoexDelayFactor")
  GET_INT     (PRM_ID_DELAY_FACTOR                         , "gCoexDelayFactor")

  SET_INT     (PRM_ID_OBSS_SCAN_INTERVAL                   , "sCoexScanIntrvl" )
  GET_INT     (PRM_ID_OBSS_SCAN_INTERVAL                   , "gCoexScanIntrvl" )

  SET_INT     (PRM_ID_SCAN_ACTIVITY_THRESHOLD              , "sCoexActTrshold" )
  GET_INT     (PRM_ID_SCAN_ACTIVITY_THRESHOLD              , "gCoexActTrshold" )

  SET_INT     (PRM_ID_SCAN_PASSIVE_DWELL                   , "sCoexPasvDwell"  )
  GET_INT     (PRM_ID_SCAN_PASSIVE_DWELL                   , "gCoexPasvDwell"  )

  SET_INT     (PRM_ID_SCAN_ACTIVE_DWELL                    , "sCoexActvDwell"  )
  GET_INT     (PRM_ID_SCAN_ACTIVE_DWELL                    , "gCoexActvDwell"  )

  SET_INT     (PRM_ID_SCAN_PASSIVE_TOTAL_PER_CHANNEL       , "sCoexPasvPerChnl")
  GET_INT     (PRM_ID_SCAN_PASSIVE_TOTAL_PER_CHANNEL       , "gCoexPasvPerChnl")

  SET_INT     (PRM_ID_SCAN_ACTIVE_TOTAL_PER_CHANNEL        , "sCoexActvPerChnl")
  GET_INT     (PRM_ID_SCAN_ACTIVE_TOTAL_PER_CHANNEL        , "gCoexActvPerChnl")
  ...
  GET_INT     (PRM_ID_AP_CAPABILITIES_MAX_ACLs             , "gAPCapsMaxACLs"  )
  ...
  SET_INTVEC  (PRM_ID_ENHANCED11B_TH                       , "sEnhanced11bTh")
  GET_INTVEC  (PRM_ID_ENHANCED11B_TH                       , "gEnhanced11bTh")

  /* 802.11w */
  SET_INT     (PRM_ID_PMF_ACTIVATED                        , "sPmfActivated")
  GET_INT     (PRM_ID_PMF_ACTIVATED                        , "gPmfActivated")
  SET_INT     (PRM_ID_PMF_REQUIRED                         , "sPmfRequired")
  GET_INT     (PRM_ID_PMF_REQUIRED                         , "gPmfRequired")
  SET_INT     (PRM_ID_SAQ_RETR_TMOUT                       , "sSAQRetrTmout")
  GET_INT     (PRM_ID_SAQ_RETR_TMOUT                       , "gSAQRetrTmout")
  SET_INT     (PRM_ID_SAQ_MAX_TMOUT                        , "sSAQMaxTmout")
  GET_INT     (PRM_ID_SAQ_MAX_TMOUT                        , "gSAQMaxTmout")

  /* FW Recovery */
  SET_INTVEC  (PRM_ID_FW_RECOVERY                          , "sFWRecovery")
  GET_INTVEC  (PRM_ID_FW_RECOVERY                          , "gFWRecovery")

  /* Multicast PS queue size */
  SET_INT     (PRM_ID_MC_PS_SIZE                           , "sMcPSsize" )
  GET_INT     (PRM_ID_MC_PS_SIZE                           , "gMcPSsize" )

  SET_INT     (PRM_ID_UAPSD_MODE                           , "sUAPSDMode")
  GET_INT     (PRM_ID_UAPSD_MODE                           , "gUAPSDMode")

  SET_INT     (PRM_ID_UAPSD_MAX_SP                         , "sUAPSDMaxSP")
  GET_INT     (PRM_ID_UAPSD_MAX_SP                         , "gUAPSDMaxSP")

#ifdef MTCFG_USE_GENL
  GET_INT     (PRM_ID_GENL_FAMILY_ID                       , "gGenlFamilyId")
#endif

  SET_INT     (PRM_ID_RA_PROTECTION                        , "sRAprotection")
  GET_INT     (PRM_ID_RA_PROTECTION                        , "gRAprotection")

  SET_INT     (PRM_ID_FORCE_NCB                            , "sForceNcb")
  GET_INT     (PRM_ID_FORCE_NCB                            , "gForceNcb")

  SET_INTVEC  (PRM_ID_N_RATES_BOS                          , "sNratesBOs")
  GET_INTVEC  (PRM_ID_N_RATES_BOS                          , "gNratesBOs")
...
struct stat_print_info_t stat_info[] =
{
  ...
  { STAT_RX_DELBA_PKT,      "Received DELBA frames" },

  { STAT_UAPSD_RX_TRIGGER_FRAMES,      "Received U-APSD trigger frames" },
  { STAT_UAPSD_TX_FRAMES_IN_SP,        "Transmitted U-APSD frames in SP " },
  { STAT_UAPSD_TX_QOS_NULL_DATA,       "Transmitted U-APSD QoS Null Data frames in SP" },
};
