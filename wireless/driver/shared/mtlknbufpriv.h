...
struct mtlk_nbuf_priv_internal
{
  ...
  /* share the next data block between of RX and TX directions */
  union {
    /* RX */
    mtlk_nbuf_t            *sub_frame;  /* pointer to skb subframe for a-msdu*/
    /* TX */
    struct {
        uint8               tx_pck_ac;  /* access category of the packet */
        uint8               tx_reserved[3];
    };
  };
...
static __INLINE void
mtlk_nbuf_priv_set_sub_frame (mtlk_nbuf_priv_t *priv,
    mtlk_nbuf_t        *nbuf)
{
  struct mtlk_nbuf_priv_internal *p = 
    (struct mtlk_nbuf_priv_internal *)priv->private;
...
mtlk_nbuf_priv_get_sub_frame (mtlk_nbuf_priv_t *priv)
{
  struct mtlk_nbuf_priv_internal *p = 
    (struct mtlk_nbuf_priv_internal *)priv->private;
...
static __INLINE uint8
mtlk_nbuf_priv_get_tx_pck_ac (mtlk_nbuf_priv_t *priv)
{
  struct mtlk_nbuf_priv_internal *p =
    (struct mtlk_nbuf_priv_internal *)priv->private;
...
static __INLINE void
mtlk_nbuf_priv_set_tx_pck_ac (mtlk_nbuf_priv_t *priv, uint8 ac)
{
  struct mtlk_nbuf_priv_internal *p =
    (struct mtlk_nbuf_priv_internal *)priv->private;
