...
// #define SCAN_LONG_CHAN_NUM  3
// #define SCAN_LONG_CHAN_MS   1000
// #define SCAN_LONG_TIMEOUT   (SCAN_TIMEOUT+(SCAN_LONG_CHAN_NUM*SCAN_LONG_CHAN_MS))
struct mtlk_scan_interf_params
{
  BOOL is_interf_enabled;
  BOOL is_long_scan_enabled;
//  BOOL is_long_scan_active;
...
struct mtlk_scan
{
  ...
  scan_completed_notification_callback_type *scan_completed_notification_callback;
