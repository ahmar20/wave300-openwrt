...
uint32 __MTLK_IFUNC mtlk_eeprom_get_xtal_value(const mtlk_eeprom_data_t *ee_data);

int8 __MTLK_IFUNC mtlk_eeprom_get_lna_gain_bypass(const mtlk_eeprom_data_t *ee_data);

int8 __MTLK_IFUNC mtlk_eeprom_get_lna_gain_high(const mtlk_eeprom_data_t *ee_data);
