...
#ifdef MTCFG_PMCU_SUPPORT
/* PCOC configuration structure */
typedef struct _ta_crit_pcoc_cfg_t {
  uint32 interval;
  uint32 coeff;
} ta_crit_pcoc_cfg_t;
#endif
...
#ifdef MTCFG_PMCU_SUPPORT
int     __MTLK_IFUNC mtlk_ta_pcoc_cfg(mtlk_handle_t ta_handle, ta_crit_pcoc_cfg_t *pcoc_cfg);
#endif
