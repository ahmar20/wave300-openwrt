...
void __MTLK_IFUNC
mtlk_dot11h_20_40_coexistence_channel_switch (mtlk_dot11h_t *dot11h_obj, uint16 channel, uint8 bonding);
...
void __MTLK_IFUNC mtlk_dot11h_on_rcvry_isol(mtlk_dot11h_t *obj);
...
void __MTLK_IFUNC mtlk_dot11h_set_dbg_channel_availability_check_time(
    mtlk_dot11h_t *obj,
    int16 channel_availability_check_time);
...
void __MTLK_IFUNC mtlk_dot11h_initial_wait_begin(mtlk_dot11h_t *obj, uint8 u8SmRequired);
void __MTLK_IFUNC mtlk_dot11h_initial_wait_end(mtlk_dot11h_t *obj);
