                         ...
                         char* buff)
{
    ...
    case CHC_SCAN_RANK:
        ...
        return;
    case CHC_SCAN_RANK_BT:
        sprintf(buff, "Scan rank BT (%u)", criteria_details->scan.rank);
        return;
    ...
    case CHC_LOWEST_TIMEOUT:
        ...
        return;
    case CHC_20_40_COEXISTENCE:
        strcpy(buff, "20/40 COEX");
        return;
    case CHC_INTERFERENCE:
        strcpy(buff, "Interference metric");
        return;
    default:
        strcpy(buff, "UNKNOWN");
        MTLK_ASSERT(FALSE);
