...
const mtlk_pdb_initial_value *mtlk_pdb_initial_values_pcig3[] = {
  mtlk_core_parameters_pcig3,         /* coremodule parameters */
  NULL,
};
#endif /* MTCFG_LINDRV_HW_PCIG3 */

#ifdef MTCFG_LINDRV_HW_PCIE
const mtlk_pdb_initial_value *mtlk_pdb_initial_values_pcie[] = {
  mtlk_core_parameters_pcie,          /* coremodule parameters */
  NULL,
};
#endif /* MTCFG_LINDRV_HW_PCIE */

#ifdef MTCFG_LINDRV_HW_AHBG35
const mtlk_pdb_initial_value *mtlk_pdb_initial_values_g35[] = {
  mtlk_core_parameters_g35,           /* coremodule parameters */
  NULL,
};
