...
int32 __MTLK_IFUNC mtlk_get_antennas_factor (uint32 antennas_num);
int16 __MTLK_IFUNC mtlk_calc_tx_power_lim (tx_limit_t *lim, uint16 channel, uint8 reg_domain,
...
int __MTLK_IFUNC mtlk_set_power_limit (mtlk_core_t *core);
...
BOOL __MTLK_IFUNC mtlk_channels_find_secondary_channel_no(mtlk_vap_handle_t vap_handle, uint16 primary_channel_no, int secondary_channel_offset, uint16 *secondary_channel_no);
